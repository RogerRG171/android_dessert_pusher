...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //create a dessert timer : update add lifecycle
        dessertTimer = DessertTimer(this.lifecycle)


        //test if bundle is not null
    ...
    //create to restore bundle - not in use now...
    ...
    //override save state to add data to bundle
    ...
    //override onStart and add Timber level Info "i" log
